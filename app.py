...
def show_citation_dialog():
    ...
    # st.code provides an interactive 'Copy' action interface out of the box
...
with st.sidebar:
    ...
    # Context-aware enabled state controlled download layout element
...
with tabs[0]:
    if st.session_state.processing_done:
        ...
        if st.session_state.main_data.empty:
            ...
            # Store selections in session state to maintain tracking across tabs once frozen
